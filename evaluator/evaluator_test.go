...
func TestErrorHandling(t *testing.T) {
	tests := []struct {
		...
		{
			"5 + true;",
			"type mismatch: INTEGER + BOOLEAN on line 1, col 3",
		},
		{
			"5 + true; 5;",
			"type mismatch: INTEGER + BOOLEAN on line 1, col 3",
		...
		{
			"-true;",
			"unknown operator: -BOOLEAN on line 1, col 1",
		},
		{
			"true + false;",
			"type mismatch: BOOLEAN + BOOLEAN on line 1, col 6",
		},
		{
			"5; true + false; 5",
			"type mismatch: BOOLEAN + BOOLEAN on line 1, col 9",
		},
		{
			"if (10 > 1) { true + false; }",
			"type mismatch: BOOLEAN + BOOLEAN on line 1, col 20",
		},
		{
			`
if (10 > 1) {
...
`,
			"type mismatch: BOOLEAN + BOOLEAN on line 4, col 17",
		},
		{
			"foobar",
			"identifier not found: foobar on line 1, col 1",
		},
		{
			`"Hello" - "World"`,
			"unknown operator for strings: - on line 1, col 9",
		},
	}
